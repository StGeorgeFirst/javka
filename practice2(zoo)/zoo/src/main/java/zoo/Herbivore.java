...
public class Herbivore extends AnimalSpecies {
    ...
    /**
     *  Method for "the drinking of animals" event
     *  Changes state of species to CALM
     *  Changes zoo info about state of herbivore type to CALM
     *  Prints species info
     */
    @Override
    ...
    /**
     *  Method for "the beginning of rain" event
     *  Changes state of species to MAKE_NOISE
     *  Changes zoo info about state of carnivore type to MAKE_NOISE
     *  Don't change zoo info about state of herbivore type
     *  Prints species info
     */
    @Override
    public void rain() {
